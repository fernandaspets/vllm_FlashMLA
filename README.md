...
```bash
git clone https://github.com/fernandaspets/vllm_sm120.git    # modified vllm build files and flashmla pyhton files to install for sm120
cd vllm_sm120 
export FLASH_MLA_SRC_DIR=/path/to/your/vllm_FlashMLA   # path to this repo
