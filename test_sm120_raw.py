#!/usr/bin/env python3
import torch, math
torch.ops.load_library("flash_mla/cuda.cpython-312-x86_64-linux-gnu.so")
sparse_op = torch.ops._flashmla_C.sparse_prefill_fwd

s_q, s_kv, h_q, h_kv, d_qk, d_v, topk = 1, 1000, 128, 1, 576, 32   # d_v = 32 → 50 % zeros if bug still present
